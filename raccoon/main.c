...
int main()
{
    int num_lives = 5, improvedRaccoonTimer = 0, slowRaccoonTimer = 0, chocolates = 0, starCount = 0;
    float points = 0, raccoonSpeed = 8.0;
    char str[1], totalPoints[1], totalChocolates[1], starCountLabel[1];
